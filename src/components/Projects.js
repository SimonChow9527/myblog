      ...
      <ol className="homepage-project-content-ol project-adjustment">
        ...
        <li className="homepage-project-content-li">
          <ProjectItem
            photo={coffee}
            title="CoffeeBuzz"
            role="Full-Stack developer | Feb 2019-Jun 2019 "
            keyword="Keyword: React, RESTful API(.NET core), Azure sql database, Project Management"
        ...
        <li className="homepage-project-content-li">
          <ProjectItem
            ...
            role="Full-Stack developer | Dec 2018-Feb 2019 "
            keyword="Keyword: .NET core MVC, Angular, RESTful API"
        ...
        <li className="homepage-project-content-li">
          <ProjectItem
            ...
            role="Full-Stack developer | Jul 2018-Oct 2018 "
            keyword="Keyword: Google Cloud, 3rd party API "
